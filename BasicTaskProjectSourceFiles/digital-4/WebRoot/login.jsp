	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form" action="loginAction" method="post" name="loginForm">
					...
					<div class="wrap-input100">
						...
						<s:textfield class="input100" type="text" name="userName" placeholder="%{getText('userName_tip')}"/>
					...
					<div class="wrap-input100">
						...
						<s:textfield class="input100" type="password" name="password" placeholder="%{getText('password_tip')}"/>
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
